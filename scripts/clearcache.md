...
# Rename as -> clearcache.sh
# Set execute permissions -> sudo chmod +x /usr/local/bin/clearcache.sh
# Remove any blocking file attributes -> xattr -cr /usr/local/bin/*
# Set an alias on .zshrc -> alias clearcache="/usr/local/bin/clearcache.sh"
# Run file on terminal -> clearcache
